      ...
      <div className="p-4 border-b border-gray-200">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">RAG-DAG 기반 개인화 AI</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {messages.length === 0 ? (
          <div className="text-center py-8">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Zauri와 대화하기</h3>
            <p className="text-gray-600">RAG-DAG 지식 그래프 기반 개인화 AI와 채팅하세요</p>
          </div>
        ) : (
          <>
